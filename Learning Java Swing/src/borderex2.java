...
public class borderex2 extends JFrame {
	...
	private void initUI() {
		...
		var exitIcon = new ImageIcon("resources");
		...
		var driveIcon = new ImageIcon("resources");
		var compIcon = new ImageIcon("resources");
		var printIcon = new ImageIcon("resources");
